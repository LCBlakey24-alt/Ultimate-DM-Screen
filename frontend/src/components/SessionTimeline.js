...
const EVENT_TYPES = [
  { id: 'session', label: 'Session', icon: Calendar, color: '#7A5AF8' },
  ...
  { id: 'level_up', label: 'Level Up', icon: Star, color: '#7A5AF8' },
  { id: 'major', label: 'Major Event', icon: Crown, color: '#D4AF37' },
